...
%{!?commit:
%global commit e03bf1ea323d39cd9a7ff9dc34189eba4c3fde90
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_MAJOR=3 OS_GIT_VERSION=v3.6.0-alpha.1+e03bf1e-1008 OS_GIT_MINOR=6+ OS_GIT_COMMIT=e03bf1e
}
...
Version:        3.6.0
Release:        0.alpha.1.1008.e03bf1e
